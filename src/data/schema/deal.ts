...
export const mutations = `
  ...
  dealsChange(itemId: String!, destinationStageId: String!, destinationIndex: Float, destinationOrder: Float, sourceStageId: String, sourceIndex: Float, updateOrderProccessId: String): Deal
