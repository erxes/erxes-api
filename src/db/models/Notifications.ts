...
export const loadNotificationClass = (models: IModels) => {
  class Notification {
    ...
    public static async createNotification(doc: INotification, createdUser?: IUserDocument | string) {
      const { Notifications, NotificationConfigurations } = models;
...
export interface INotificationConfigModel extends Model<IConfigDocument> {
...
export const loadNotificationConfigClass = (models: IModels) => {
  class Configuration {
    /**
    ...
    public static async createOrUpdateConfiguration(
      ...
      const { NotificationConfigurations } = models;
