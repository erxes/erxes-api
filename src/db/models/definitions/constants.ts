...
export const NOTIFICATION_TYPE_ACTIONS = {
  [NOTIFICATION_TYPES.CONVERSATION_ADD_MESSAGE]: 'sent you a message',
  [NOTIFICATION_TYPES.CONVERSATION_ASSIGNEE_CHANGE]: '',
  [NOTIFICATION_TYPES.CONVERSATION_STATE_CHANGE]: '',
  [NOTIFICATION_TYPES.CHANNEL_MEMBERS_CHANGE]: '',
};
