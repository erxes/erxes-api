...
export interface IKnowledgebaseArticleModel extends Model<IArticleDocument> {
...
export const loadArticleClass = (models: IModels) => {
  class Article {
    ...
    public static async createDoc({ categoryIds, ...docFields }: IArticleCreate, userId?: string) {
      const { KnowledgeBaseArticles, KnowledgeBaseCategories } = models;
    ...
    public static removeDoc(_id: string) {
      const { KnowledgeBaseArticles } = models;
...
export interface IKnowledgebaseCategoryModel extends Model<ICategoryDocument> {
...
export const loadCategoryClass = (models: IModels) => {
  class Category {
    ...
    public static async createDoc({ topicIds, ...docFields }: ICategoryCreate, userId?: string) {
      const { KnowledgeBaseCategories, KnowledgeBaseTopics } = models;
    ...
    public static async removeDoc(_id: string) {
      const { KnowledgeBaseCategories, KnowledgeBaseArticles } = models;
...
export interface IKnowledgebaseTopicModel extends Model<ITopicDocument> {
...
export const loadTopicClass = (models: IModels) => {
  class Topic {
    ...
    public static createDoc(docFields: ITopic, userId?: string) {
      const { KnowledgeBaseTopics } = models;
     ...
     */
    public static async removeDoc(_id: string) {
      const { KnowledgeBaseTopics, KnowledgeBaseCategories } = models;
